...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("mud"), bytes16("Attribute")));
...
library Attribute {
  ...
  function setAttributeType(bytes32 key, AttributeTypes attributeType) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked(uint8(attributeType)));
  }
  ...
  function setAttributeType(IStore _store, bytes32 key, AttributeTypes attributeType) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked(uint8(attributeType)));
  }
  ...
  function setHealthMax(bytes32 key, int32 healthMax) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 1, abi.encodePacked((healthMax)));
  }
  ...
  function setHealthMax(IStore _store, bytes32 key, int32 healthMax) internal {
    ...
    _store.setField(_tableId, _keyTuple, 1, abi.encodePacked((healthMax)));
  }
  ...
  function setStrength(bytes32 key, int32 strength) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 2, abi.encodePacked((strength)));
  }
  ...
  function setStrength(IStore _store, bytes32 key, int32 strength) internal {
    ...
    _store.setField(_tableId, _keyTuple, 2, abi.encodePacked((strength)));
  }
  ...
  function setStaminaRegen(bytes32 key, int32 staminaRegen) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 3, abi.encodePacked((staminaRegen)));
  }
  ...
  function setStaminaRegen(IStore _store, bytes32 key, int32 staminaRegen) internal {
    ...
    _store.setField(_tableId, _keyTuple, 3, abi.encodePacked((staminaRegen)));
  }
  ...
  function setStaminaCost(bytes32 key, int32 staminaCost) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 4, abi.encodePacked((staminaCost)));
  }
  ...
  function setStaminaCost(IStore _store, bytes32 key, int32 staminaCost) internal {
    ...
    _store.setField(_tableId, _keyTuple, 4, abi.encodePacked((staminaCost)));
  }
  ...
  function setMoveSpeed(bytes32 key, int32 moveSpeed) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 5, abi.encodePacked((moveSpeed)));
  }
  ...
  function setMoveSpeed(IStore _store, bytes32 key, int32 moveSpeed) internal {
    ...
    _store.setField(_tableId, _keyTuple, 5, abi.encodePacked((moveSpeed)));
  }
  ...
  function setHeal(bytes32 key, int32 heal) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 6, abi.encodePacked((heal)));
  }
  ...
  function setHeal(IStore _store, bytes32 key, int32 heal) internal {
    ...
    _store.setField(_tableId, _keyTuple, 6, abi.encodePacked((heal)));
  }
  ...
  function setRangeMin(bytes32 key, int32 rangeMin) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 7, abi.encodePacked((rangeMin)));
  }
  ...
  function setRangeMin(IStore _store, bytes32 key, int32 rangeMin) internal {
    ...
    _store.setField(_tableId, _keyTuple, 7, abi.encodePacked((rangeMin)));
  }
  ...
  function setRangeMax(bytes32 key, int32 rangeMax) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 8, abi.encodePacked((rangeMax)));
  }
  ...
  function setRangeMax(IStore _store, bytes32 key, int32 rangeMax) internal {
    ...
    _store.setField(_tableId, _keyTuple, 8, abi.encodePacked((rangeMax)));
  }
