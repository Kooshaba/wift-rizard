...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("mud"), bytes16("MonsterType")));
bytes32 constant MonsterTypeTableId = _tableId;
...
library MonsterType {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("MonsterType", _fieldNames);
  }
