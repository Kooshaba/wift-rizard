...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("mud"), bytes16("equippedBy"))));
uint256 constant EquippedByTableId = _tableId;
